...
public final class Loader extends JFrame {
                ...
                try {
                    ...
                    SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
                        ...
                        protected Void doInBackground() throws Exception {
                            ...
                            File dir = new File(Signlink.getCacheDirectory());
                            if (!dir.exists() && !dir.mkdir()) {
                                throw new Exception("Unable to create directory " + Signlink.getCacheDirectory());
                            }
                            ...
                            File existingClient = new File(Signlink.getCacheDirectory() + "client.jar");
                            ...
                            try {
                                ...
                                out = new FileOutputStream(Signlink.getCacheDirectory() + "client.jar");
                                ...
                                frame.status.setText("Error loading client...Please post a bug report in the Discord");
                        ...
                        protected void done() {
                            ...
                            try {
                                ...
                                pb.directory(new File(Signlink.getCacheDirectory()));
                                pb.start();
    ...
    public Loader() {
        ...
        status = new JLabel("Getting the latest client updates...Please wait a few moments...");
