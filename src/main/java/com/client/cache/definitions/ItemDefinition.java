...
public final class ItemDefinition {
	...
	private static void customItems(ItemDefinition itemDef) {
		...
		case 33269:
			itemDef.name = "Galax Mystery Box";
			itemDef.inventoryOptions = new String[] { "Open", null, null, null, "Drop" };
	...
	private static void customItems2(ItemDefinition itemDef) {
		...
		case 33482:
			itemDef.name = "Galax platebody (T2)";
			itemDef.description = "An upgraded set of Galax armor.";
			...
			break;
		case 33483:
			itemDef.name = "Galax platelegs (T2)";
			itemDef.description = "An upgraded set of Galax armor.";
		...
		case 33487:
			itemDef.name = "Galax platebody (T1)";
			...
			break;
		case 33488:
			itemDef.name = "Galax platelegs (T1)";
			itemDef.description = "You can upgrade this armor to T2 at 1500 total level.";
...
//			legs drop - 53134	
		...
		case 33524:
			...
			break;
				...
				case 33558:
					itemDef.name = "Galax cape";
					itemDef.description = "A cape created for Galax players.";
...
//			break;
		...
		case 33956:
			...
			itemDef.description = "A top from the 2019 Christmas event on Galax.";
		...
		case 33957:
			...
			itemDef.description = "A pair of pants from the 2019 Christmas event on Galax.";
...
case 33958:
	...
	itemDef.description = "A mask from the 2019 Christmas event on Galax.";
...
case 33959:
	...
	itemDef.description = "A wand from the 2019 Christmas event on Galax.";
...
case 33960:
	...
	itemDef.description = "A rapier from the 2019 Christmas event on Galax.";
