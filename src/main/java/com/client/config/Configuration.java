...
public class Configuration {
	...
	public static boolean staffIcons = false;
	public static int chatColor = 0;
    public static int fogColor = 0xDCDBDF;
	public static long fogDelay = 500;
	public static final String CLIENT_TITLE = "Galax | Your #1 Custom OSRS Experience";
	public static final String SHORT_CLIENT_TITLE = "Galax";
	...
	public static final String CACHE_NAME = "GalaxCache1";

	public static final String CACHELINK = "http://galax-ps.com/cache/cache.zip"; //  cache link
