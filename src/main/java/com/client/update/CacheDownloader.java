...
public class CacheDownloader {
	...
	private String BETA_CACHE_LINK = "http://galax-ps.com/cache/cache.zip";

	private static String VERSION_FILE_URL = "http://galax-ps.com/cache/version.txt";
	private static String BETA_VERSION_FILE_URL = "http://galax-ps.com/cache/version.txt";
	...
	private void downloadFile(String adress, String localFileName) {
		...
		try {
			...
			while ((numRead = in.read(data)) != -1) {
				...
				drawLoadingText((int)percentage, "Galax - Downloading Cache " + percentage + "%");

			}
			System.out.println(localFileName + "\t" + numWritten);
			drawLoadingText("Galax - Unzipping...");
